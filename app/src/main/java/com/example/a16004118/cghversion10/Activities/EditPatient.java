...
public class EditPatient extends AppCompatActivity {
    ...
    PatientAndMedicalDetail patient;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        patient = (PatientAndMedicalDetail) intent.getSerializableExtra("Patient");
...
//                databaseReferenceChit.child(idFbChit).setValue(patientAndMedicalDetail);
                ...
                databaseReferenceChit.child(patient.getIdFB()).setValue(patientAndMedicalDetail);
